    ...
    <>
      <div className="container-fluid bg-light">
        ...
        <div className="flex-container">
          <h1>
            La Cabaña del saber es un lugar para ser y sentir, es un lugar para
            expresar tu ser y tus motivaciones por nuevos aprendizajes.
          </h1>
          <p>
            Natalia Hernandez, madre y mujer Bogotana, es la creadora de este
            grandioso proyecto de educación dirigido a familias que educan en
            casa y que quieren tener un proceso de desescolarización. Es curiosa
            por naturaleza y siempre ha pensado en como generar nuevos espacios
            de educación en donde las familias se sientan cómodas y libres para
            expresarse a su manera. Desde muy joven se intereso por diferentes
            temas de educación y ha liderado diferentes espacios con familias,
            niños y adultos mayores. Licenciada en Pedagogía Infantil bilingue,
            con formación en ámbitos artísticos y arteterapia, cuidado de la
            naturaleza, diplomado en valores humanos, con curso en Programación
            Neurolinguistica entre otros.
          </p>
          <h2>¿QUIÉNES SOMOS?</h2>
          <p>
          ...
          <h2>¿QUÉ HACEMOS?</h2>
          <p>
            Facilitamos el desarrollo de proyectos de aprendizaje de familias
            que educan en casa, es decir, el conocimiento se aborda de una
            manera global en donde todos los contenidos están conjugados. Así
            mismo, es un enfoque multifuncional para abordar la utilidad de los
          ...
          <h2>MISIÓN</h2>
          <p>
            Buscamos asesorar, acompañar y fortalecer las practicas educativas
            de las familias que han decidido educar en casa. Nuestro enfoque,
            está estructurado a través de la formulación de proyectos de
            aprendizaje los cuales potencian la autonomía y pensamiento crítico
            y se complementan con diferentes estrategias de educación emocional,
          ...
          <p>
            ...
            <br /> <br /> <strong>Respeto:</strong> es una consideración o valor
            especial que se la da a una persona o a un objeto, además de ser uno
            de los valores fundamentales que se debe tener presente a la hora de
